...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        listWidgetColores->setGeometry(QRect(20, 30, 761, 401));
        labelColorSeleccionado = new QLabel(centralwidget);
        labelColorSeleccionado->setObjectName("labelColorSeleccionado");
        labelColorSeleccionado->setGeometry(QRect(20, 450, 761, 41));
        labelColorSeleccionado->setAlignment(Qt::AlignmentFlag::AlignCenter);
        textEditInfo = new QTextEdit(centralwidget);
        textEditInfo->setObjectName("textEditInfo");
        textEditInfo->setGeometry(QRect(20, 500, 761, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelColorSeleccionado->setText(QCoreApplication::translate("MainWindow", "Selecciona el color:", nullptr));
    } // retranslateUi
